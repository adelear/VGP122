...
void ResourceManager::removeInstance(ResourceManager*)
{
	if (instance)
		delete instance;
}
...
void ResourceManager::addGameObject(int depth, Object* o)
{
	gameObjects[depth] = o;
}

std::unordered_map<std::string, SDL_Texture*> ResourceManager::resources;
std::map<int, Object*> ResourceManager::gameObjects;
