...
Sprite::Sprite(SDL_Renderer* r, std::string filename, int x, int y, int w, int h, int rows, int cols, int offsetX, int offsetY, double a, SDL_RendererFlip flip) : renderer(r), position(x, y), w(w), h(h), angle(a), offsetX(offsetX), offsetY(offsetY), flipFlag(flip)
{
