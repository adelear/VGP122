...
void Deck::createCards()
{
	for (int i = 0; i < NUMCARDS / 2; ++i)
	{
		...
		cards.push_back(new Card(gameObjectName.str(), "images/cards.png", 0, 0, 1, 12, rndCard));
		cards.push_back(new Card(gameObjectNameDup.str(), "images/cards.png", 0, 0, 1, 12, rndCard));
	}
}
