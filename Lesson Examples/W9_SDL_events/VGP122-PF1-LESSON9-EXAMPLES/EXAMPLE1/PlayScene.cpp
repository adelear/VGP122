...
PlayScene::PlayScene()
{
	bg = new Image("bg", "images/bg.png", 0, 0);
	charSelect = new Image("charSelect", "images/characterSelect.png", 0, 0);
	cursor1 = new Cursor("player1", "images/cursor.png", 191, 216, 41, 70, 4, 1);
	cursor2 = new Cursor("player2", "images/cursor.png", 317, 223, 41, 70, 4, 1);
}
...
bool PlayScene::onEnter()
{
	...
	addGameObject(bg, 0);
	addGameObject(charSelect, 1);
	addGameObject(cursor1, 2);
	addGameObject(cursor2, 3);
